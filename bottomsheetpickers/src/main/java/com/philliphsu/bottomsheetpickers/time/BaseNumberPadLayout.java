 ...
 */
public class BaseNumberPadLayout extends ViewGroup {

    private int mRowCount;
    private int mColumnCount;

    public BaseNumberPadLayout(Context context) {
        this(context, null);
    }

    public BaseNumberPadLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BaseNumberPadLayout(Context context, AttributeSet attrs, int defStyle) {
